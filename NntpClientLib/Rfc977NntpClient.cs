...
namespace NntpClientLib
{
    ...
    public class Rfc977NntpClient : IDisposable
    {
        ...
        public virtual String PostArticle(IArticleHeaderEnumerator header, IEnumerable<string> body)
        {
            if (header == null)
            {
            ...
            String messageId = ExtractMessageID(NntpReaderWriter.ReadResponse());
            ...
            NntpReaderWriter.Write("Message-ID: ");
            NntpReaderWriter.WriteLine(messageId);
        ...
        /// <summary>
        /// Posts an article with a binary payload.
        /// </summary>
        /// <param name="header">The header.</param>
        ...
        public virtual string PostArticle(IArticleHeaderEnumerator header, IEnumerable<String> prefix, Byte[] body, IEnumerable<String> suffix)
        {
            ...
            NntpReaderWriter.Write(body, 0, body.Length);
